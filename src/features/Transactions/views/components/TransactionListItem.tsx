...
type TransactionListItemProps = {
  ...
  isTypeRoute: number
  index: number
  alertDeleteHandler?: (index: number) => void
}

export const TransactionListItem = React.memo(
  ({ item, isTypeRoute, index, alertDeleteHandler }: TransactionListItemProps) => {
    ...
    return (
      ...
      >
        ...
        <Column maxWidth='10%' justifyContent='flex-end'>
          <Button backgroundColor='transparent' onPress={() => alertDeleteHandler?.(index)}>
